...
int main(void)
{
    ...
    //If else ka tadka
    if (prashant == 0 && rushi == 0 && varun == 0 && reuben == 0)
    {
        printf("Why so zero?\n");
    }
    else
    {
        printf("You entered non-zero values for your friends\n");
    }
    //In the above code, '&&'' sign means 'AND', and '=='' sign means 'Is Equal To'. These signs are known as operators.
}
